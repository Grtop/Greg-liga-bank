import {
  MAX_CARCREDIT_PERCENT,
  MEDIUM_CARCREDIT_PERCENT,
  MEDIUM_CARCREDIT_PRICE,
  SMALLEST_CARCREDIT_PERCENT,
  SMALL_CARCREDIT_PERCENT,
} from "./const";

export const getCleanedNumber = (formattedString: string) =>
  +formattedString.replace(/\s/gi, "").replace(/рублей/gi, "");
